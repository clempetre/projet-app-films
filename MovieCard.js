...
const MovieCard = ({ movie, itemWidth }) => {
  ...
  return (
    <View style={[styles.card, { width: itemWidth }, isWatched(movie.id) && styles.watchedCard]}>
...
{detailedMovie && (
<>
<Text style={styles.modalDuration}>Durée : {detailedMovie.runtime || 'Non disponible'} minutes</Text>
